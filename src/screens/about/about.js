      ...
      <Card containerStyle={styles.cardContainer}>
        ...
        <View style={stylesp.section}>
          ...
          <TouchableOpacity
            onPress={() =>
              handleUrl(
                "https://acrobat.adobe.com/id/urn:aaid:sc:US:530d4769-7ebd-47e3-ab1e-432b1b8d730d"
              )
            }
          >
            <Text style={stylesp.linkspdf}>
              <Icon name="file-pdf-o" size={20} color="#257157" /> Ofício
              19/2023/ VS
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() =>
              handleUrl(
                "https://acrobat.adobe.com/id/urn:aaid:sc:US:e63a9dd1-5e7f-4497-946e-e6d69fdd7f2f"
              )
            }
          >
            <Text style={stylesp.linkspdf}>
              <Icon name="file-pdf-o" size={20} color="#257157" /> Nota técnica
              n.º 04 /2018 - DGCDA/SEVS/SES-PE
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity
          onPress={() =>
            handleUrl("http://www.ouricuri.pe.gov.br/novosite/secretaria/20/")
          }
        >
        ...
        <TouchableOpacity
          onPress={() => handleUrl("http://www.ouricuri.pe.gov.br/novosite/")}
        >
          <Text style={stylesp.link}>
